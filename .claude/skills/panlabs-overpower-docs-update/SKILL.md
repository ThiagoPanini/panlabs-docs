...
description: Confere a documentação do overpower publicada neste acervo contra a ferramenta real, corrige a deriva que achar, e move o pino. Use quando uma versão nova do overpower for publicada, ou quando pedirem para varrer a doc do overpower.
---
