...
| `conteudo/ferramentas/` | 22 |

Mais o ramo gerado, somado por fora — **54 no site**, 50 autorais mais 4 geradas. Acrescentar ou remover página **exige acertar o portão 4 junto**. São quatorze cobranças ao todo; a lista está no cabeçalho de `scripts/portao-4-conteudo.sh`.
...
**Só `Ferramentas` é traduzida** — 26 folhas, cobertura cobrada pelo portão 4. As outras duas abas existem só em pt-BR, e isso é decisão, não pendência: `docs/design/informacao.md` § 8. Locale.
