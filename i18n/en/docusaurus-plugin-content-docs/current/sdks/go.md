...
the standard library. Requires Go 1.23 or newer — the pagination iterator is
range-over-func, which landed there.
...
func ListarLiquidadas(ctx context.Context) error {
	// Range-over-func — this is what requires Go 1.23.
