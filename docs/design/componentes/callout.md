...
| Ícone e título na tinta da variante, corpo não | herdado + origem própria | [#4](https://github.com/panlabs-tech/shinydoc-docusaurus/issues/4) mede ícone e texto na mesma cor sólida; deixar o corpo fora preserva o par de contraste que [`tokens.md`](../tokens.md) §10 verificou |
