...
:root {
  ...
  /* ---------------------------------------------------------------------------
     ...
     Com este piso e `repeat(auto-fit, minmax(min(…, 100%), 1fr))`, a contagem de
     cartões faz o trabalho sozinha — zero media query, zero container query,
     zero prop de colunas.
     --------------------------------------------------------------------------- */
