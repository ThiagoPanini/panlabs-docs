...
| [#57](https://github.com/ThiagoPanini/panlabs-docs/issues/57) `Jornadas`, e o décimo tipo de página | [`informacao.md`](informacao.md) §6 — os dez tipos, com o gabarito de cada um |
