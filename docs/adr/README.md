...
| 9 | [A referência de CLI é gerada de contrato de superfície de comando](0009-referencia-de-cli-gerada-de-contrato-de-superficie-de-comando.md) — espécies `aplicacao` e `comando`, quatro entradas, a máquina do 8 inteira | escrito |
