...
- **Esconder a flag recusada em vez de desabilitá-la.** Recusado: uma flag que some quando outra é ligada faz o leitor procurar o que acabou de ver. Desabilitada, com a mensagem que a ferramenta imprime ao lado, ela **ensina a regra** — que é a diferença entre um painel que impede o erro e um que o explica.
