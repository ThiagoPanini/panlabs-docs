...
- **Editou `contracts/*.json`? Rode `npm run generate:reference`.** O portão 5 regenera e reprova em `git diff`. A página gerada nunca se edita à mão.
